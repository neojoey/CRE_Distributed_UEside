...
public:
  ...
  virtual void SetPa (double pa) = 0;
	...
	// by Joey
	// Update Bias value in PHY layer, currently apply on only rsrp vlaue
	virtual void UpdateBias (double bias, uint16_t cellId) = 0;
...
public:
  ...
  virtual void ReportUeMeasurements (UeMeasurementsParameters params) = 0;
	...
	//by Joey
	//brief Save a global outage count at RRC layer for managing Q-table
	virtual void SaveGlobalOutageCount (uint32_t outageCount) = 0;
...
public:
  ...
  virtual void SetPa (double pa);
	virtual void UpdateBias (double bias, uint16_t cellId);
...
template <class C>
void
MemberLteUeCphySapProvider<C>::UpdateBias (double bias, uint16_t cellId)
{
  m_owner->DoUpdateBias (bias, cellId);
}
...
public:
  ...
  virtual void ReportUeMeasurements (LteUeCphySapUser::UeMeasurementsParameters params);
	...
	//by Joey
	virtual void SaveGlobalOutageCount (uint32_t outageCount);
...
template <class C>
void
MemberLteUeCphySapUser<C>::SaveGlobalOutageCount (uint32_t outageCount)
{
  m_owner->DoSaveGlobalOutageCount (outageCount);
}
