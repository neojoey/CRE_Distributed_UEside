...
public:
  ...
  struct UeDataParams
  {
	...
	//by Joey for outageCount
	struct OutageCountParams
	{
		uint16_t	sourceCellId;
		uint32_t	outageCount;
	};
...
public:
  ...
  virtual void SendUeData (UeDataParams params) = 0;
	...
	//by Joey
	virtual void SendOutageCount (OutageCountParams params) = 0;
	
	virtual void SendGlobalOutageCount (OutageCountParams params) = 0;
...
public:
  ...
  virtual void RecvUeData (UeDataParams params) = 0;
	...
	//by Joey
	virtual void RecvOutageCount (OutageCountParams params) = 0;
	
	virtual void RecvGlobalOutageCount (OutageCountParams params) = 0;
};
...
public:
  ...
  virtual void SendUeData (UeDataParams params);
	...
	//by Joey
	virtual void SendOutageCount (OutageCountParams params);
	
	virtual void SendGlobalOutageCount (OutageCountParams params);
...
template <class C>
void
EpcX2SpecificEpcX2SapProvider<C>::SendOutageCount (OutageCountParams params)
{
  m_x2->DoSendOutageCount (params);
}

template <class C>
void
EpcX2SpecificEpcX2SapProvider<C>::SendGlobalOutageCount (OutageCountParams params)
{
  m_x2->DoSendGlobalOutageCount (params);
}
...
public:
  ...
  virtual void RecvUeData (UeDataParams params);
	...
	//by Joey
	virtual void RecvOutageCount (OutageCountParams params);
	
	virtual void RecvGlobalOutageCount (OutageCountParams params);
...
template <class C>
void
EpcX2SpecificEpcX2SapUser<C>::RecvOutageCount (OutageCountParams params)
{
  m_rrc->DoRecvOutageCount (params);
}

template <class C>
void
EpcX2SpecificEpcX2SapUser<C>::RecvGlobalOutageCount (OutageCountParams params)
{
  m_rrc->DoRecvGlobalOutageCount (params);
}
