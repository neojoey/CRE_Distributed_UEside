...
AbsCtrlMessage::AbsCtrlMessage (void)
{
	SetMessageType (LteControlMessage::ABS);
}
...
OutageCtrlMessage::OutageCtrlMessage (void)
{
	SetMessageType (LteControlMessage::OUTAGE);
	SetOutageCount (0);
}
...
void 
OutageCtrlMessage::SetOutageCount ( double nb )
{
	m_outageCount = nb;
}

double 
OutageCtrlMessage::GetOutageCount ( void )
{
