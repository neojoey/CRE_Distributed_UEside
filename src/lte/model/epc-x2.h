...
protected:
  ...
  virtual void DoSendUeData (EpcX2SapProvider::UeDataParams params);
	//by Joey
	virtual void DoSendOutageCount (EpcX2SapProvider::OutageCountParams params);
	virtual void DoSendGlobalOutageCount (EpcX2SapProvider::OutageCountParams params);
