...
// by Joey
// OutageCountHeader
NS_OBJECT_ENSURE_REGISTERED (EpcX2OutageCountHeader);

EpcX2OutageCountHeader::EpcX2OutageCountHeader()
  : m_numberOfIes (2),
    m_headerLength (2+4)
{
}
...
TypeId
EpcX2OutageCountHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::EpcX2OutageCountHeader")
    .SetParent<Header> ()
    .SetGroupName("Lte")
    .AddConstructor<EpcX2OutageCountHeader> ()
  ;
  return tid;
}

TypeId
EpcX2OutageCountHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

uint32_t
EpcX2OutageCountHeader::GetSerializedSize (void) const
{
  return m_headerLength;
}

void
EpcX2OutageCountHeader::Serialize (Buffer::Iterator start) const
{
  Buffer::Iterator i = start;

  i.WriteU16 (m_outageCount.sourceCellId);               // source cell ID
  i.WriteU32 (m_outageCount.outageCount);                // Outage Count
}

uint32_t
EpcX2OutageCountHeader::Deserialize (Buffer::Iterator start)
{
  Buffer::Iterator i = start;
  ...
  m_numberOfIes = 0;
	...
	/*
	EpcX2Sap::OutageCountParams outageParams;
	outageParams.sourceCellId = i.ReadU16 ();
  outageParams.outageCount = i.ReadU32 ();
	*/
	m_outageCount.sourceCellId = i.ReadU16 ();
	m_outageCount.outageCount = i.ReadU32 ();
  m_headerLength+=6;
  m_numberOfIes=+2;
...
void
EpcX2OutageCountHeader::Print (std::ostream &os) const
{
  os << "Cell Id = " << m_outageCount.sourceCellId <<" OutageCount= " << m_outageCount.outageCount;
}

EpcX2Sap::OutageCountParams
EpcX2OutageCountHeader::GetOutageCount () const
{
  return m_outageCount;
}

void
EpcX2OutageCountHeader::SetOutageCount(EpcX2Sap::OutageCountParams outageParams)
{
	m_outageCount.sourceCellId = outageParams.sourceCellId;
	m_outageCount.outageCount = outageParams.outageCount;
}

uint32_t
EpcX2OutageCountHeader::GetSourceCellId()
{
	return m_outageCount.sourceCellId;
}

uint16_t
EpcX2OutageCountHeader::GetOutageCount()
{
	return m_outageCount.outageCount;
}

uint32_t
EpcX2OutageCountHeader::GetLengthOfIes () const
{
  return m_headerLength;
}

uint32_t
EpcX2OutageCountHeader::GetNumberOfIes () const
{
  return m_numberOfIes;
}
...
////////////////////////////////////////////
// by Joey
// GlobalOutageCountHeader
NS_OBJECT_ENSURE_REGISTERED (EpcX2GlobalOutageCountHeader);

EpcX2GlobalOutageCountHeader::EpcX2GlobalOutageCountHeader()
  : m_numberOfIes (2),
    m_headerLength (2+4)
{
}
...
TypeId
EpcX2GlobalOutageCountHeader::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::EpcX2GlobalOutageCountHeader")
    .SetParent<Header> ()
    .SetGroupName("Lte")
    .AddConstructor<EpcX2GlobalOutageCountHeader> ()
  ;
  return tid;
}

TypeId
EpcX2GlobalOutageCountHeader::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

uint32_t
EpcX2GlobalOutageCountHeader::GetSerializedSize (void) const
{
  return m_headerLength;
}

void
EpcX2GlobalOutageCountHeader::Serialize (Buffer::Iterator start) const
{
  Buffer::Iterator i = start;

  i.WriteU16 (m_globalOutageCount.sourceCellId);               // source cell ID
  i.WriteU32 (m_globalOutageCount.outageCount);                // Outage Count
}

uint32_t
EpcX2GlobalOutageCountHeader::Deserialize (Buffer::Iterator start)
{
  Buffer::Iterator i = start;
  ...
  outageParams.outageCount = i.ReadU32 ();
	*/
	m_globalOutageCount.sourceCellId = i.ReadU16 ();
	m_globalOutageCount.outageCount = i.ReadU32 ();
  m_headerLength+=6;
  m_numberOfIes=+2;
...
void
EpcX2GlobalOutageCountHeader::Print (std::ostream &os) const
{
  os << "Cell Id = " << m_globalOutageCount.sourceCellId <<" GlobalOutageCount= " << m_globalOutageCount.outageCount;
}

EpcX2Sap::OutageCountParams
EpcX2GlobalOutageCountHeader::GetOutageCount () const
{
  return m_globalOutageCount;
}

void
EpcX2GlobalOutageCountHeader::SetOutageCount(EpcX2Sap::OutageCountParams outageParams)
{
	m_globalOutageCount.sourceCellId = outageParams.sourceCellId;
	m_globalOutageCount.outageCount = outageParams.outageCount;
}

uint32_t
EpcX2GlobalOutageCountHeader::GetSourceCellId()
{
	return m_globalOutageCount.sourceCellId;
}

uint16_t
EpcX2GlobalOutageCountHeader::GetOutageCount()
{
	return m_globalOutageCount.outageCount;
}

uint32_t
EpcX2GlobalOutageCountHeader::GetLengthOfIes () const
{
  return m_headerLength;
}

uint32_t
EpcX2GlobalOutageCountHeader::GetNumberOfIes () const
{
  return m_numberOfIes;
}
