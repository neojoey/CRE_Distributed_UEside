...
public:
  ...
  enum ProcedureCode_t {
    ...
    SnStatusTransfer        = 4,
    UeContextRelease        = 5,
		OutageCount							= 7,	//by Joey
		GlobalOutageCount		= 8,	//by Joey
...
class EpcX2OutageCountHeader : public Header
{
public:
  EpcX2OutageCountHeader();
  virtual ~EpcX2OutageCountHeader();
  ...
  EpcX2Sap::OutageCountParams GetOutageCount () const;
  void SetOutageCount(EpcX2Sap::OutageCountParams outageCount);
	uint32_t GetSourceCellId ();
	uint16_t GetOutageCount ();
...
private:
  ...
  EpcX2Sap::OutageCountParams m_outageCount;
};

//by Joey for GloablOutageCount
class EpcX2GlobalOutageCountHeader : public Header
{
public:
  EpcX2GlobalOutageCountHeader();
  virtual ~EpcX2GlobalOutageCountHeader();
...
private:
  ...
  EpcX2Sap::OutageCountParams m_globalOutageCount;
};
