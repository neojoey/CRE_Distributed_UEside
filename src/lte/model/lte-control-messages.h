...
public:
  ...
  enum MessageType
  {
    ...
    SIB1, // System Information Block Type 1
		ABS, 	// ABS notification for UE so it can calculate correct CQI
		OUTAGE, // the number of outage UEs for update bias Q-table
  };
...
class AbsCtrlMessage : public LteControlMessage
{
	public:
		AbsCtrlMessage (void);
		virtual ~AbsCtrlMessage (void);
...
// for Distributed bias algorithm #1 by joey 2015.05.03
class OutageCtrlMessage : public LteControlMessage
{
	public:
		OutageCtrlMessage (void);
		virtual ~OutageCtrlMessage (void);

		void SetOutageCount ( double nb );

		double GetOutageCount (void);
